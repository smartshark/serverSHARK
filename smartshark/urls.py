...
urlpatterns = [
    ...
    url(r'^smartshark/project/verify/$', collection.verify_project, name='project_verify'),
    url(r'^smartshark/project/verify_details/$', collection.verify_project_details, name='project_verify_details'),
